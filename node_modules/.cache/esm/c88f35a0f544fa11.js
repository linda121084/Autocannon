let Table,format;_f54‍.x([["report",()=>report]]);_f54‍.w("cli-table",[["default",["Table"],function(v){Table=v}]]);_f54‍.w("date-fns",[["format",["format"],function(v){format=v}]]);
...
const non2xxTable = new Table({
  ...
  _f54‍.g.console.log(primaryTable.toString());
  // console.log(percentileTable.toString());
  _f54‍.g.console.log(extrasTable.toString());
  _f54‍.g.console.log(non2xxTable.toString());
